...
const Data = {
    ...
    saveSeries(series) {
        localStorage.setItem(this.KEYS.SERIES, JSON.stringify(series));
    },
    ...
    saveTurmas(turmas) {
        localStorage.setItem(this.KEYS.TURMAS, JSON.stringify(turmas));
    },
    ...
    saveDisciplinas(disciplinas) {
        localStorage.setItem(this.KEYS.DISCIPLINAS, JSON.stringify(disciplinas));
    },
    ...
    savePalavras(palavras) {
        localStorage.setItem(this.KEYS.PALAVRAS, JSON.stringify(palavras));
    },
    ...
    addAdminLog(action, section, details) {
        ...
        localStorage.setItem(this.KEYS.ADMIN_LOGS, JSON.stringify(logs));
    },

    clearAdminLogs() {
        localStorage.setItem(this.KEYS.ADMIN_LOGS, JSON.stringify([]));
    },
