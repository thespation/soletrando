...
const Admin = {
            ...
            return `
                <div class="card-list-item serie-card ${isActive ? '' : 'serie-inactive'}">
                    ...
                    <div class="card-item-actions">
                        ${isActive ? `<button class="btn-icon-sm danger" data-action="toggle-series" data-id="${s.id}" title="${T('Desativar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="m9 12 2 2 4-4"/></svg></button>` : `<button class="btn-icon-sm" data-action="toggle-series" data-id="${s.id}" title="${T('Reativar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg></button>`}
                        <button class="btn-icon-sm" data-action="edit-series" data-id="${s.id}" title="${T('Editar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg></button>
                        <button class="btn-icon-sm danger" data-action="delete-series" data-id="${s.id}" title="${T('Excluir')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg></button>
                    </div>
                    ${turmas.length > 0 ? `
                    <div class="serie-turmas-list">
                        ...
                        <div class="serie-turma-item">
                            ...
                            <div class="serie-turma-actions">
                                <button class="btn-icon-sm" data-action="edit-turma-inline" data-id="${t.id}" title="${T('Editar turma')}"><svg class="icon-lucide" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg></button>
                                <button class="btn-icon-sm danger" data-action="delete-turma-inline" data-id="${t.id}" title="${T('Excluir turma')}"><svg class="icon-lucide" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg></button>
                            </div>
                        </div>`).join('')}
                    </div>` : ''}
                </div>`;
        ...
        const turmaRows = existingTurmas.map(t => `
            <div class="form-turma-row" data-turma-id="${t.id}">
                ...
                <div class="form-turma-row-actions">
                    <button class="btn-icon-sm danger" onclick="Admin.removeFormTurmaRow(this)" title="${T('Remover turma')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
                </div>
            </div>`).join('');
        ...
        container.innerHTML = `
            ...
            <div class="form-row">
                <div>
                    ...
                    <input type="text" id="input-series-name" value="${serie?.nome || ''}" placeholder="${T('Ex: 6º Ano')}">
                </div>
                <div>
                    <label>${T('Professor(a) Responsável')}</label>
            ...
            <div class="form-turmas-section">
                ...
                <button class="btn btn-sm btn-outline form-turmas-add" onclick="Admin.addFormTurmaRow()">
            ...
            <div class="form-actions">
                <button class="btn btn-secondary" onclick="Admin.closeForm('series-form-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                <button class="btn btn-primary" onclick="Admin.saveSeries(${id ? `'${id}'` : 'null'})"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> ${T('Salvar')}</button>
            </div>`;
    ...
    addFormTurmaRow() {
        ...
        row.innerHTML = `
            ...
            <div class="form-turma-row-actions">
                <button class="btn btn-sm btn-outline" onclick="Admin.addTurmaSettingsInline(this)" style="visibility:hidden">${T('Configurações')}</button>
                <button class="btn-icon-sm danger" onclick="Admin.removeFormTurmaRow(this)" title="${T('Remover turma')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
            </div>`;
    ...
    showSeriesBulkImportForm() {
        ...
        container.innerHTML = `
            ...
            <div class="bulk-actions">
                <button class="btn btn-secondary" onclick="Admin.addSeriesBulkRow()">
                ...
                <div style="display: flex; gap: 0.5rem;">
                    <button class="btn btn-secondary" onclick="Admin.closeForm('series-bulk-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                    <button class="btn btn-primary" onclick="Admin.saveBulkSeries()">
            ...
            <td>
                <div class="bulk-turmas-cell">
                    <div class="bulk-turma-row">
                        ...
                        <button class="btn-icon-sm danger" onclick="Admin.removeBulkTurmaRow(this)" title="${T('Remover turma')}">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" x2="6" y1="6" y2="18"/><line x1="6" x2="18" y1="6" y2="18"/></svg>
                        </button>
                    </div>
                    <button class="btn btn-sm btn-outline" onclick="Admin.addBulkTurmaRow(this)" style="margin-top:4px">
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="5" y2="19"/><line x1="5" x2="19" y1="12" y2="12"/></svg>
                        ${T('Turma')}
                    </button>
                </div>
            </td>
            <td>
                <button class="btn-icon-sm danger" onclick="this.closest('tr').remove()" title="${T('Remover série')}">
    ...
    showTurmaForm(id = null) {
        ...
        container.innerHTML = `
            ...
            <div class="form-actions">
                <button class="btn btn-secondary" onclick="Admin.closeForm('series-form-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                <button class="btn btn-primary" onclick="Admin.saveTurma('${id}')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> ${T('Salvar')}</button>
            </div>`;
    ...
    async _resolveCardImages(container) {
        ...
        list.innerHTML = disciplinas.map(d => {
            ...
            return `
                <div class="card-list-item">
                    ...
                    <div class="card-item-actions">
                        <button class="btn-icon-sm" data-action="edit-disciplina" data-id="${d.id}" title="${T('Editar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg></button>
                        <button class="btn-icon-sm danger" data-action="delete-disciplina" data-id="${d.id}" title="${T('Excluir')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg></button>
                    </div>
                </div>`;
        }).join('');
    },
        ...
        container.innerHTML = `
            ...
            <div class="form-row single">
                <div>
                    ...
                    <input type="text" id="input-disciplina-name" value="${disciplina?.nome || ''}" placeholder="${T('Ex: Matemática')}">
                </div>
            </div>
            <div class="form-row single">
                <div>
            ...
            <div class="form-actions">
                <button class="btn btn-secondary" onclick="Admin.closeForm('disciplinas-form-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                <button class="btn btn-primary" onclick="Admin.saveDisciplina(${id ? `'${id}'` : 'null'})"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> ${T('Salvar')}</button>
            </div>`;
    ...
    showDisciplinaBulkImportForm() {
        ...
        container.innerHTML = `
            ...
            <div class="bulk-actions">
                <button class="btn btn-secondary" onclick="Admin.addDisciplinaBulkRow()">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="5" y2="19"/><line x1="5" x2="19" y1="12" y2="12"/></svg>
                    ${T('Adicionar Disciplina')}
                </button>
                <div style="display: flex; gap: 0.5rem;">
                    <button class="btn btn-secondary" onclick="Admin.closeForm('disciplinas-bulk-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                    <button class="btn btn-primary" onclick="Admin.saveBulkDisciplinas()">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/></svg>
                        ${T('Salvar Todas')}
                    </button>
                </div>
    ...
    addDisciplinaBulkRow() {
        ...
        row.innerHTML = `
            ...
            <td>
                <button class="btn-icon-sm danger" onclick="this.closest('tr').remove()" title="${T('Remover disciplina')}">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" x2="6" y1="6" y2="18"/><line x1="6" x2="18" y1="6" y2="18"/></svg>
                </button>
            </td>`;
        tbody.appendChild(row);
    ...
    renderWords() {
        ...
        list.innerHTML = palavras.map(p => {
            ...
            return `
                <div class="card-list-item">
                    ${p.imagem ? `<span class="card-item-img-wrap" data-action="crop-word" data-id="${p.id}" title="${T('Ajustar imagem')}"><img class="card-item-img" src="${isDisk ? '' : p.imagem}" data-disk="${isDisk ? p.imagem : ''}" style="${this.cropStyle(p.crop)}" alt=""></span>` : ''}
                    <div class="card-item-info">
                    ...
                    <div class="card-item-actions">
                        <button class="btn-icon-sm" data-action="edit-word" data-id="${p.id}" title="${T('Editar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg></button>
                        <button class="btn-icon-sm danger" data-action="delete-word" data-id="${p.id}" title="${T('Excluir')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg></button>
                    </div>
                </div>`;
        }).join('');
        ...
        container.innerHTML = `
            ...
            <div class="form-row">
                <div>
                    ...
                    <input type="text" id="input-word-text" value="${palavra?.texto || ''}" placeholder="${T('Ex: AÇÃO')}" style="text-transform: uppercase;">
                </div>
                <div>
                    <label>${T('Dica')}</label>
                    <input type="text" id="input-word-hint" value="${palavra?.dica || ''}" placeholder="${T('Ex: Ato de fazer')}">
                </div>
            </div>
            <div class="form-row">
                <div>
                    ...
                    <select id="select-word-series" onchange="Admin.updateDisciplinasForSeries()">
                        ...
                        ${series.map(s => `<option value="${s.id}" ${palavra?.serieId === s.id ? 'selected' : ''}>${s.nome}</option>`).join('')}
                    </select>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="image-upload-row">
                        ...
                        <div style="display:flex;flex-direction:column;gap:0.75rem;align-self:flex-start">
                            ...
                            <button type="button" class="btn btn-secondary btn-small" onclick="Admin.removeWordImage()" id="btn-remove-word-image" ${palavra?.imagem ? '' : 'style="display:none"'}>
                        ...
                        <div style="display:flex;flex-direction:column;gap:0.75rem;flex:1;min-width:0">
                            ...
                            <button type="button" class="btn btn-secondary btn-small" onclick="Admin.previewImageUrl()" style="align-self:flex-end">
            ...
            <div class="form-actions">
                <button class="btn btn-secondary" onclick="Admin.closeForm('words-form-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                <button class="btn btn-primary" onclick="Admin.saveWord(${id ? `'${id}'` : 'null'})"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> ${T('Salvar')}</button>
            </div>`;
        ...
        if (existing) {
            try {
                ...
                const hasDir = async (n) => {
                    try { await existing.getDirectoryHandle(n); return true; } catch { return false; }
                };
                connected = perm === 'granted' && (await hasDir('img') || await hasDir('js'));
            } catch {}
        }

        let result;
        if (connected) {
            if (!confirm(T('A pasta do sistema atual é "{nome}". Deseja trocar para outra pasta?', { nome: existing.name }))) {
                this.refreshSystemFolderStatus();
                return;
            }
            result = await Data.connectSystemFolder(true);
        } else {
            result = await Data.connectSystemFolder(false);
        }
    ...
    updateDisciplinasForSeries(selectedDisciplinaId = null) {
        ...
        selectDisciplina.innerHTML = `<option value="">${T('Selecione...')}</option>` +
            disciplinas.map(d => `<option value="${d.id}" ${d.id === selectedDisciplinaId ? 'selected' : ''}>${d.nome}</option>`).join('');
    },
    ...
    showBulkImportForm() {
        ...
        container.innerHTML = `
            ...
            <div class="bulk-apply-row">
                ...
                <button class="btn btn-secondary btn-small" onclick="Admin.applyBulkSeriesDisciplina()" style="align-self: flex-end; margin-bottom: 2px;">
            ...
            <div class="bulk-actions">
                <button class="btn btn-secondary" onclick="Admin.addBulkRow()">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="5" y2="19"/><line x1="5" x2="19" y1="12" y2="12"/></svg>
                    ${T('Adicionar Linha')}
                </button>
                <div style="display: flex; gap: 0.5rem;">
                    <button class="btn btn-secondary" onclick="Admin.closeForm('words-bulk-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                    <button class="btn btn-primary" onclick="Admin.saveBulkWords()">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/></svg>
                        ${T('Salvar Todas')}
                    </button>
                </div>
    ...
    addBulkRow() {
        ...
        row.innerHTML = `
            ...
            <td>
                <button class="btn-icon-sm danger" onclick="this.closest('tr').remove()" title="${T('Remover linha')}">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" x2="6" y1="6" y2="18"/><line x1="6" x2="18" y1="6" y2="18"/></svg>
                </button>
            </td>`;
        tbody.appendChild(row);
    ...
    loadEvents() {
        ...
        list.innerHTML = eventos.map(e => `
            <div class="card-list-item" data-evento-id="${e.id}">
                ...
                <div class="card-item-actions">
                    <button class="btn-icon-sm" data-action="toggle-event-detail" data-id="${e.id}" title="${T('Ver detalhes')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg></button>
                    <button class="btn-icon-sm" data-action="edit-event" data-id="${e.id}" title="${T('Editar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/><path d="m15 5 4 4"/></svg></button>
                    <button class="btn-icon-sm" data-action="duplicate-event" data-id="${e.id}" title="${T('Duplicar rodadas')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg></button>
                    <button class="btn-icon-sm" data-action="export-event-pdf" data-id="${e.id}" title="${T('Exportar PDF')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9V2h12v7"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect width="12" height="8" x="6" y="14"/></svg></button>
                    ${e.status === 'ativo' ? `<button class="btn-icon-sm danger" data-action="close-event" data-id="${e.id}" title="${T('Encerrar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="m9 12 2 2 4-4"/></svg></button>` : `<button class="btn-icon-sm" data-action="reopen-event" data-id="${e.id}" title="${T('Reativar')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg></button>`}
                    <button class="btn-icon-sm danger" data-action="delete-event" data-id="${e.id}" title="${T('Excluir')}"><svg class="icon-lucide" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg></button>
                </div>
            </div>`).join('');
    },
        ...
        container.innerHTML = `
            ...
            <div class="form-row">
                <div>
                    ...
                    <input type="text" id="input-event-name" value="${evento?.nome || ''}" placeholder="${T('Ex: Feira de Ciências')}">
                </div>
                <div>
                    <label>${T('Data')}</label>
            ...
            <div class="form-row single">
                <div>
                    ...
                    <button type="button" class="btn btn-secondary btn-small" onclick="Admin.addRodada()" style="margin-top: 0.5rem;">+ ${T('Adicionar Rodada')}</button>
                </div>
            </div>
            <div class="form-actions">
                <button class="btn btn-secondary" onclick="Admin.closeForm('events-form-container')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg> ${T('Cancelar')}</button>
                <button class="btn btn-primary" onclick="Admin.saveEvent(${id ? `'${id}'` : 'null'})"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> ${T('Salvar')}</button>
            </div>`;
        ...
        return `
            <div class="rodada-form" data-index="${index}">
                <div class="rodada-header">
                    ...
                    <button type="button" class="btn btn-danger btn-small" onclick="Admin.removeRodada(${index})">${T('Remover')}</button>
                </div>
                <div class="rodada-row top">
                    <div class="rodada-field">
                        ...
                        <select id="rodada-serie-${index}" onchange="Admin.updateRodadaTurmasDisciplinas(${index})">
                            <option value="">${T('Selecione...')}</option>
                            ${seriesComPalavras.map(s => `<option value="${s.id}" ${rodada?.serieId === s.id ? 'selected' : ''}>${s.nome}</option>`).join('')}
                        </select>
                    </div>
                    <div class="rodada-field">
                        ...
                        <select id="rodada-turma-${index}">
                            ...
                            ${turmas.map(t => `<option value="${t.id}" ${rodada?.turmaId === t.id ? 'selected' : ''}>${t.nome}</option>`).join('')}
                        </select>
                    </div>
                ...
                <div class="rodada-row">
                    <div class="rodada-field stretch">
                        <div class="palavras-mode-compact">
                            ...
                            <button type="button" class="palavras-mode-chip ${modoPalavras === 'sorteio' ? 'active' : ''}" data-mode="sorteio" onclick="Admin.setModoPalavras(${index}, 'sorteio')">${T('Sorteio')}</button>
                            <button type="button" class="palavras-mode-chip ${modoPalavras === 'selecao' ? 'active' : ''}" data-mode="selecao" onclick="Admin.setModoPalavras(${index}, 'selecao')">${T('Selecionar')}</button>
                ...
                <div class="rodada-row">
                    <div class="rodada-field stretch">
                        ...
                        <div class="participantes-tags" id="rodada-participantes-${index}">
                            ${participantes.map((p, pi) => `<span class="participante-tag">${Utils.escapeHtml(p.nome)}<button onclick="Admin.removeParticipante(${index},${pi})">×</button></span>`).join('')}
                        </div>
                        <div class="participante-add-row">
                            ...
                            <button type="button" class="btn btn-secondary btn-small" onclick="Admin.addParticipante(${index})">+</button>
                        </div>
                    </div>
                </div>
            </div>`;
    ...
    _renderWordSelectionList(index, palavras, selectedIds = []) {
        ...
        let html = `<div class="palavras-select-actions">
            ...
            <button type="button" class="btn btn-secondary btn-small" onclick="Admin.toggleAllWords(${index}, true)">${T('Todas')}</button>
            <button type="button" class="btn btn-secondary btn-small" onclick="Admin.toggleAllWords(${index}, false)">${T('Limpar')}</button>
        ...
        if (selected.length > 0) {
            ...
            selected.forEach(({ palavra: p }, idx) => {
                html += `<label class="palavra-chip selected" data-term="${Utils.escapeHtml(p.texto.toLowerCase())}">
                    ...
                    <span class="palavra-order visible" onclick="event.stopPropagation();Admin.setPalavraOrder(${index},'${p.id}',parseInt(prompt('${T('Nova posição:')}')||'0'))">${idx + 1}</span>
                    <span class="palavra-texto">${Utils.escapeHtml(p.texto)}</span>
                    <button class="palavra-move" onclick="event.stopPropagation();Admin.movePalavraOrder(${index},'${p.id}',-1)" tabindex="-1">&#9650;</button>
                    <button class="palavra-move" onclick="event.stopPropagation();Admin.movePalavraOrder(${index},'${p.id}',1)" tabindex="-1">&#9660;</button>
                </label>`;
            });
            html += '</div></div>';
        ...
        container.innerHTML = `
            ...
            <div class="event-summary">
                ...
                <div class="event-summary-actions">
                    <button class="btn btn-primary" onclick="App.startEventGame('${evento.id}')">
                    ...
                    <button class="btn btn-secondary" onclick="Admin.closeForm('events-form-container'); Admin.loadEvents();">${T('Fechar')}</button>
                </div>
            </div>`;
        container.classList.remove('hidden');
    },
    ...
    exportEventPDF(id) {
        ...
        const rodadasHtml = (evento.rodadas || []).map((r, i) => {
            const serie = series.find(s => s.id === r.serieId);
            ...
            if (temSelecao) {
                ...
                palavrasHtml = `<div class="word-list"><strong>${T('Palavras Selecionadas ({n}):', { n: palavras.length })}</strong><ol class="word-ordered">` +
                    palavras.map(p => `<li>${Utils.escapeHtml(p.texto)} <span class="word-disc">(${disciplinas.find(d => d.id === p.disciplinaId)?.nome || '?'})</span></li>`).join('') +
                    `</ol></div>`;
            } else {
                const pool = allPalavras.filter(p =>
                    p.serieId === r.serieId && (r.disciplinaIds || []).includes(p.disciplinaId)
            ...
            return `
                <div class="round">
                    ...
                    <table class="round-info">
                        <tr><td><strong>${T('Série')}:</strong></td><td>${serie?.nome || '?'}</td></tr>
...
<body>
    ...
    addParticipante(rodadaIndex) {
        ...
        tag.innerHTML = `${Utils.escapeHtml(nome)}<button onclick="Admin.removeParticipante(${rodadaIndex}, ${container.children.length})">×</button>`;
        ...
        container.innerHTML = groups.map((g, idx) => {
            ...
            <div class="event-exec-group glass">
                <div class="event-exec-header">
                    ...
                    <button class="btn-icon-sm danger event-exec-delete" data-exec-idx="${idx}" title="${T('Excluir execução')}">
        ...
        container.innerHTML = groups.map((g, idx) => {
            ...
            <div class="event-exec-group glass">
                <div class="event-exec-header">
                    ...
                    <span class="event-exec-date">${dtStr}</span>
                    <span class="event-exec-badge">${g.total} ${T(g.total !== 1 ? 'palavras' : 'palavra')} · ${g.acertos} ${T(g.acertos !== 1 ? 'acertos' : 'acerto')} · ${g.taxa}%</span>
                    <button class="btn-icon-sm danger event-exec-delete" data-exec-id="${execId}" data-exec-idx="${idx}" title="${T('Excluir execução')}">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>
                    </button>
                </div>
                <div class="event-logs-table-wrap">
    ...
    async loadBackupInfo() {
        ...
        let backups = [];
        try { backups = await Data.listBackups(); } catch {}
        ...
        for (const b of backups) {
            ...
            html += `<tr>
                ...
                <td class="backup-actions">
                    <button class="btn btn-secondary btn-small" onclick="Admin.restoreBackup('${Utils.escapeHtml(b.name)}')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg> ${T('Restaurar')}</button>
                    <button class="btn btn-secondary btn-small btn-danger-text" onclick="Admin.deleteBackup('${Utils.escapeHtml(b.name)}')"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg> ${T('Excluir')}</button>
                </td>
            </tr>`;
        }
    ...
    async saveLocalBackup() {
        ...
        if (btn) { btn.disabled = false; btn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/></svg> ' + T('Salvar Backup'); }
    },
    ...
    async exportAll() {
        ...
        try {
            ...
            console.log(`[Export] ${embeddedCount} imagens embutidas no JSON`);

            const opfsImages = await Utils.collectAllImagesFromOPFS();
            console.log(`[Export] ${opfsImages.length} imagens brutas do OPFS`);
    ...
    async _doImportOverwriteAll() {
        ...
        try {
            ...
            if (!success) { alert(T('Erro ao importar dados. Verifique o formato.')); if (btn) { btn.disabled = false; btn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/></svg> ' + T('Importar'); } return; }
        ...
        if (btn) { btn.disabled = false; btn.innerHTML = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"/><path d="M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"/><path d="M7 3v4a1 1 0 0 0 1 1h7"/></svg> ' + T('Importar'); }
    },
