    ...
    renderResumo() {
        ...
        el.innerHTML = `
            ...
            <div class="event-phase-body event-resumo">
                ...
                ${warningsHtml}
                <button class="btn btn-primary btn-large event-start-btn" ${!temAlguma ? 'disabled' : ''} data-action="iniciar-evento">
    ...
    renderRodada() {
        ...
        if (participanteAtual) {
            contentHtml = `
                ...
                <button class="btn-confirm-event" data-action="start-student" data-nome="${Utils.escapeHtml(participanteAtual.nome)}">
                ...
                <div class="event-rodada-custom">
                    ...
                    <button class="btn-custom-arrow" data-action="start-student-from-input"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg></button>
                </div>`;
        } else {
            contentHtml = `
        ...
        el.innerHTML = `
            ...
            <div class="event-phase-body event-center">
                ...
                ${contentHtml}
                <button class="event-skip-btn" data-action="skip-round">${podePular ? T('Pular esta rodada →') : T('Encerrar evento →')}</button>
            </div>`;
    },
